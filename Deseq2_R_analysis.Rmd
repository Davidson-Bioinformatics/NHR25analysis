...
First make a folder that will have a folder with each of the quant files in it. In the folder "BIO343" (where this Rmarkdown is) click "New Folder" and name it “salmon_quant” (do not use spaces when naming your folders). Within this folder make 6 other folders for each samples name: wildtype_1, wildtype_2, wildtype_3, ku217_1, ku217_2, ku217_3. 
